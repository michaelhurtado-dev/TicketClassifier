...
categories = {
    ...
    "Data Fix": ["df","data fix","need data fix","datafix","refill smoothing","Cap RX suffix DF"],
    ...
    "General Error": ["not working","error","ERROR:APP-IEU-241025","Issues","shortcuts missing"],
